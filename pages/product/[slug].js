...
const Post = ({ buyNow, addToCart, product, variants }) => {
  ...
  const cheakServiceability = async () => {
    ...
    if (pinJson.includes(parseInt(pin))) {
      ...
      toast.success("🦄Yep this pincode is servicable!", {
      ...
      setService(false);
      toast.warn("🦄 Oops! This pincode is not serviceable", {
        position: "bottom-center",
        autoClose: 1500,
        hideProgressBar: false,
        closeOnClick: true,
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                <div className="flex">
                  ...
                  {Object.keys(variants).includes("red") && (
                    <button
                      ...
                      className="border-2 border-gray-300 ml-1 bg-red-700 rounded-full w-6 h-6 focus:outline-none"
                    ></button>
                  )}
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    {/* <select 
                    value={size} onChange={(e)=>{refreshVarient(e.target.value,color)}} className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-pink-200 focus:border-pink-500 text-base pl-3 pr-10">

                      {/* For further time stamp is at 44 minute in video 49 */}
  ...
  <option>xxl</option>
              ...
              <div className="flex">
                ...
                <button
                  onClick={() => {
                    buyNow(slug, 1, 569, "Wear the code(XL,Red)", "XL", "Red");
                  }}
                  className="flex md:ml-8 text-white bg-pink-500 border-0 py-2 ,px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Buy Now
                </button>
                <button
                  onClick={() => {
                    toast.success("🦄Your item is added in the cart", {
                      position: "bottom-center",
                      autoClose: 1500,
                      hideProgressBar: false,
                      closeOnClick: true,
                  ...
                  className="flex md:ml-4 text-white bg-pink-500 border-0 py-2 px-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded"
                >
                  Add to cart
                </button>
              ...
              <div className="pin mt-6 flex space-x-2 text-sm">
                <input
                  ...
                  placeholder="Enter your's pincode here!!"
                  type="text"
                />
                <button
                  onClick={cheakServiceability}
              ...
              {!service && service != null && (
                <div className="text-red-700 sm mt-3 ">
                  Sorry!! We do not delivered to this pin code yet
                </div>
              )}
              {service && service != null && (
                <div className="text-green-700 sm mt-3 ">
...
export async function getServerSideProps(context) {
  ...
  let varient = await Product.find({ title: product.title,category:product.category });
  let colorSizeSlug = {};
  ...
  return {
    props: {
      product: JSON.parse(JSON.stringify(colorSizeSlug)),
